        ...
        registerbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (enteredfirstname.isEmpty() || enteredlastname.isEmpty()) {
                    Alertor.toast(RegisterScreen.this, R.string.please_enter_your_full_name);
                    return;
                }

                if (enteredaddress.isEmpty()) {
                    Alertor.toast(RegisterScreen.this, R.string.please_enter_your_address);
                    return;
                }

                if (enteredorganization.isEmpty()) {
                    Alertor.toast(RegisterScreen.this, R.string.please_enter_your_organization);
                    return;
                }

                if (!ValidationUtils.isValidEmail(enteredEmail)) {
                    Alertor.toast(RegisterScreen.this, R.string.please_enter_a_valid_email_address);
                    return;
                }

                if (!ValidationUtils.isValidPhoneNumber(enteredphonenumber)) {
                    Alertor.toast(RegisterScreen.this, R.string.please_enter_a_valid_10_digit_phone_number);
                    return;
                }
                if (!isValidPassword(enteredPassword)) {
                    ...
                    Alertor.toast(RegisterScreen.this, R.string.please_enter_a_stronger_password);
                    return;
                }
                                        ...
                                        db.collection("Accounts")
                                                ...
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    public void onSuccess(Void unused) {
                                                        ...
                                                        Alertor.toast(RegisterScreen.this, R.string.account_created_successfully);
                                                ...
                                                .addOnFailureListener(new OnFailureListener() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        ...
                                                        Alertor.toast(RegisterScreen.this, R.string.failed_to_create_account);
                                                    }
                                                });
                                    } else {
                                        // Firebase Auth failed
                                        Alertor.toast(RegisterScreen.this, getString(R.string.registration_failed) + task.getException().getMessage());
                                    }
                                }
                            });
                } else {
                    // Passwords do not match — show error
                    Alertor.toast(RegisterScreen.this, R.string.passwords_do_not_match);
                }
            }
        });
